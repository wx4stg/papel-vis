...
def r_z_centers_edges_mesh(data, ctralt):
    """
    ...
    """
    # -- Centers
    rr_c, az_c, el_c = coords_2d(data = data, centers = True)
    # -- Edges
    rr_e, az_e, el_e = coords_2d(data = data, centers = False)
    # -- Coordinates Systems
    ctrlat, ctrlon = data.Latitude, data.Longitude
